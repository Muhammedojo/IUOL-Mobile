...
class ReportPreviewView
    extends StatelessView<ReportPreview, ReportPreviewController> {
  const ReportPreviewView(ReportPreviewController state, {Key? key})
      : super(state, key: key);
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        padding:
                            REdgeInsets.symmetric(horizontal: 15, vertical: 19),
                        decoration: BoxDecoration(
